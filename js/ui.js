...
// ═══════════════════════════════════════════════════════
// PHOTO SOURCE — uses native browser picker (iOS shows Take Photo / Library natively)
// ═══════════════════════════════════════════════════════
var _camCtx = null, _camTarget = 'photo';
function showPhotoSourcePicker(tid, target) {
  _camCtx = tid;
  _camTarget = target || 'photo';
  // Trigger native file input — iOS automatically shows Take Photo / Photo Library sheet
  if (_camTarget === 'photo') {
...
// Keep these as no-ops so any existing calls don't break
...
document.getElementById('asset-file').addEventListener('change', function() {
