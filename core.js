...
async function loadAllData() {
  ...
  var [hives,insp,txn,docs,assets,harv,treat,rem,contacts,feedings,photos] = results.map(function(r){ return r.status==='fulfilled'?r.value:[]; });
  DATA.hives = hives;
  ...
  DATA.feedings = (feedings||[]).map(function(f){return{...f,entries:f.entries||[]};});
  PHOTOS = {};
